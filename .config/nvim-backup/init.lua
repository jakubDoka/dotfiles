...
require('nvim-treesitter.configs').setup {
  ...
  ensure_installed = { 'c', 'cpp', 'go', 'lua', 'rust', 'tsx', 'typescript', 'vim', 'proto', 'sql', 'jsdoc', 'javascript' },
...
local servers = {
  ...
  tsserver = {
    cmd = { "typescript-language-server", "--stdio", "--downlevelIteration" }
  },
  lua_ls = {
    Lua = {
...
do
  ...
  local i, t, s, c = ls.insert_node, ls.text_node, ls.snippet, ls.choice_node

  ls.add_snippets(nil, {
    zig = {
      s("palc", { t("alc: std.mem.Allocator") }),
      s("deinit", fmt(
        "pub fn deinit(self: *{}{}) void {{\n\t{}\n\tself.* = undefined;\n}}",
        { i(1, "Self"), c(2, { t ", alc: std.mem.Allocator", t "" }), i(3) }
      )),
      s("raii", fmt(
        "var {} = {};\ndefer {}.deinit({});\n",
        { i(1), i(2), rep(1), i(3) }
